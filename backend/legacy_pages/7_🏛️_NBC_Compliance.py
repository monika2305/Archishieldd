...
# ── Run checks ────────────────────────────────────────────────────────────────
st.title(adapt_title("🇮🇳 NBC 2016 BIM Compliance Checker", "🇮🇳 Building Code Pass/Fail Summary"))
st.caption(adapt_caption("Validates your IFC model against National Building Code of India 2016 standards.", "Which NBC 2016 requirements your model meets — and the consequences of each failure."))
...
st.markdown("---")
st.subheader(adapt_title("📊 Overall NBC 2016 Compliance", "📊 Building Code Readiness"))
...
# ── NBC Section Scores ────────────────────────────────────────────────────────
st.subheader(adapt_title("📋 NBC 2016 Section-wise Results", "📋 What Passed & What Failed"))
