...
# ── Run ───────────────────────────────────────────────────────────────────────
st.title(adapt_title("🏢 Storey-wise Quality Score", "🏢 Floor-by-Floor Risk Rating"))
st.caption(adapt_caption("Individual BIM quality score for every floor. Elements assigned to a storey via IfcRelContainedInSpatialStructure are grouped per floor. Elements without storey assignment appear in the Unassigned bucket.", "Which floors have the most data problems — affecting quantities, compliance, and cost estimates."))
...
with tab1:
    st.subheader(adapt_title("Floor-by-Floor Quality Scores", "Floor-by-Floor Risk Summary"))
    st.caption(adapt_caption("Each floor is scored 0–100 based on proxy ratio, Pset completeness, and clean element count.", "Red floors have data issues that will affect cost estimates and compliance for that level."))
...
with tab2:
    st.subheader(adapt_title("Element Details per Floor", "Problem Elements per Floor"))
...
# ── TAB 3 — Summary Table ─────────────────────────────────────────────────────
with tab3:
    st.subheader(adapt_title("All Floors — Summary Table", "All Floors — Risk Table"))
