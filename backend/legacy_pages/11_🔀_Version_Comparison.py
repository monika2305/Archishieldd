...
st.title(adapt_title("🔀 IFC Version Comparison", "🔀 Model Change Summary"))
st.caption(adapt_caption("Upload two versions of the **same** IFC model to detect added, removed, reclassified and modified elements.", "What changed between two model versions — and what those changes mean for cost and schedule."))
st.markdown("---")
...
st.markdown("---")
st.subheader(adapt_title("📊 Comparison Summary", "📊 What Changed & Why It Matters"))
