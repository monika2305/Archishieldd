...
# PAGE HEADER
# ══════════════════════════════════════════════════════════════════════════════
st.title(adapt_title("🔎 Proxy Classification", "🔎 Element Type Issues"))
st.caption(adapt_caption("All IfcBuildingElementProxy elements are classified into Valid, Invalid, or Unknown based on their element names.", "Elements that lost their type during export — these cannot be used for cost estimates or compliance checks."))
st.markdown("---")
...
# ── TAB 1 — Invalid ────────────────────────────────────────────────────────────
with tab1:
    st.subheader(adapt_title("❌ Invalid Proxies — Semantic Data Loss", "❌ High Risk Elements — Need Reclassification"))
    st.caption(
...
# ── TAB 2 — Valid ─────────────────────────────────────────────────────────────
with tab2:
    st.subheader(adapt_title("✅ Valid Proxies — Reference / Non-physical Elements", "✅ Low Risk Elements — Acceptable"))
    st.caption(
...
# ── TAB 3 — Unknown ───────────────────────────────────────────────────────────
with tab3:
    st.subheader(adapt_title("❓ Unknown Proxies — Manual Review Required", "❓ Unclassified Elements — Review Needed"))
    st.caption(
