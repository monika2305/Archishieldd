...
st.title(adapt_title("📊 Model Quality Score", "📊 Model Readiness Report"))
...
st.subheader(adapt_title("🧮 Score Breakdown", "🧮 What Is Affecting Your Score"))
st.caption(adapt_caption("Score = Semantic Score − Proxy Penalty + Pset Score", "Your model score reflects how ready it is for downstream use — costing, compliance, and handover."))
...
# ── How to improve ────────────────────────────────────────────────────────────
st.markdown("---")
st.subheader(adapt_title("📈 How to Improve Your Score", "📈 Action Plan — Fix These First"))
