...
# ── Header ─────────────────────────────────────────────────────────────────────
st.title(adapt_title("🔥 Issue Heatmap — 2D Floor Plan Overlay", "🔥 Problem Zones — Where Issues Are Concentrated"))
st.caption(adapt_caption("Spatial issue density map · Hover any cell for a full breakdown · Colour = issue density per zone", "Darker zones have more data problems affecting cost and compliance for those areas."))
